document.addEventListener('DOMContentLoaded', () => {
    ...
    const questions = [
      ...
      { 
        text: "Що робити при панічній атаці?", 
        answer: "1. Знайди безпечне місце\n2. Зосередься на предметах навколо (назви їх кольори)\n3. Дихай повільно через нос\n4. Пам'ятай - це тимчасово і безпечно\n5. Випий води" 
      },
      { 
